...
```
src/
  actions/: Redux related actions + Thunks
  components/: React related components
  constants/: Redux related constants but not limited
  functions/: Backend code to handle databases
  reducer/: Redux related reducers
  services/: Utility requireing promises
```
...
## When to use Thunk?
* When redux and promise should be used.
